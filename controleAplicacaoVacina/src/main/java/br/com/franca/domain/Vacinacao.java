...
@Table(name = "tb_vacinacao", uniqueConstraints = @UniqueConstraint(columnNames = { "vacina_id", "dose",
		"pessoa_id" }, name = "UK_TB_VACINACAO_VACINA_ID_DOSE_PESSOA_ID"), indexes = {
...
public class Vacinacao {
	...
	public Vacinacao(Vacina vacina, Pessoa pessoa, LocalDate dataDeVacinacao) {
		this.vacina = vacina;
		this.pessoa = pessoa;
		dataVacinacao = dataDeVacinacao;
	}
